...
if render_target == 'vscode':
    ...
    example_line = "   - 예: `HTML 저장. <경로>. Simple Browser POST 완료(VSCode 패널 표시). fallback URL http://jm4.local:9876/htm-doc?path=<경로>` + 핵심 요약\n"
    ...
    example_line = "   - 예: `HTML 저장. <경로>. hub URL http://jm4.local:9876/htm-doc?path=<경로>` + 핵심 요약\n"
    ...
    example_line = "   - 예: `HTML 저장. <경로>. hub URL http://jm4.local:9876/htm-doc?path=<경로> 브라우저 열림.` + 핵심 요약\n"
